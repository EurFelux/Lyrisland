...
- Every track could show the same meaningless lyrics: Musixmatch results are now scored against the track Musixmatch actually matched, so the identical decoy response it returns for any query is rejected (#102)
